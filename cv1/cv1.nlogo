...
to move
  ifelse random-movement [
    rt one-of [-30 1 30]
    set xcor xcor + (step-size * dx)
    set ycor ycor + (step-size * dy)
  ] [
...
to move-boxes
  ask patches with [pcolor = brown] [
    ...
    let nearest-blank one-of (patches in-radius 5 with [pcolor = black])
    set pcolor black
    ask nearest-blank [
      set pcolor brown
    ]
...
<experiments>
  <experiment name="experiment" repetitions="1" runMetricsEveryStep="true">
    ...
    <enumeratedValueSet variable="random-movement">
      <value value="true"/>
      <value value="false"/>
    </enumeratedValueSet>
