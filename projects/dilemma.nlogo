...
;  if (strategy = "strategy-a") [ strategy-a ]
;  if (strategy = "strategy-b") [ strategy-b ]
;  if (strategy = "strategy-c") [ strategy-c ]  
;  if (strategy = "strategy-d") [ strategy-d ]  
end
...
"" ""
PENS
"human" 1.0 0 -16777216 true "" ""
"computer" 1.0 0 -13345367 true "" ""
...
human-strategy
human-strategy
"random" "cooperate" "defect" "tit-for-tat" "tit-for-two-tats" "unforgiving"
2
...
<experiments>
  <experiment name="experiment1" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>play</go>
    <metric>human-score</metric>
    <metric>computer-score</metric>
    <enumeratedValueSet variable="number-of-rounds">
      <value value="50"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="human-strategy">
      <value value="&quot;random&quot;"/>
      <value value="&quot;cooperate&quot;"/>
      <value value="&quot;defect&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="computer-strategy">
      <value value="&quot;cooperate&quot;"/>
    </enumeratedValueSet>
  </experiment>
</experiments>
