...
to go
  ...
  ask patches
    [ ifelse live-neighbors = count-to-restore
      [ifelse live-neighbors > 4 [ cell-birth cell-birth ] [cell-birth]]
      [ ifelse live-neighbors != 2
        [ cell-death ] [ if live-neighbors > 2 [ cell-birth cell-birth ] ] ] 
    ;;
      ]
